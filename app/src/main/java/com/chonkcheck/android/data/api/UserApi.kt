...
import com.chonkcheck.android.data.api.dto.CompleteOnboardingResponse
...
interface UserApi {
    ...
    suspend fun completeOnboarding(@Body request: CompleteOnboardingRequest): CompleteOnboardingResponse
